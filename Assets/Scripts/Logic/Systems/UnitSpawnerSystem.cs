...
namespace TD.Logic.Systems
{
    public partial struct UnitSpawnerSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            var systemHandle = state.WorldUnmanaged.GetExistingUnmanagedSystem<UnitSpawnerSystem>();
            state.WorldUnmanaged.ResolveSystemStateRef(systemHandle).Enabled = false;
        }
    } 
}
